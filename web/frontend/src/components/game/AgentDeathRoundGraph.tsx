...
export const options = {
    ...
    plugins: {
        ...
        title: {
            display: true,
            text: "Agents Remaining at the end of each fight round",
        },
    },
};
...
interface AgentDeathRoundGraphProps {
    agents: Array<number>
    threshold: number
}

export function AgentDeathRoundGraph({agents, threshold}: AgentDeathRoundGraphProps) {
