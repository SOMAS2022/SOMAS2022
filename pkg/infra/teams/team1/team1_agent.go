...
func (s *SocialAgent) CreateManifesto(_ agent.BaseAgent) *proposal.Manifesto {
...
func (s *SocialAgent) HandleElectionBallot(b agent.BaseAgent, _ *proposal.ElectionParams) proposal.Ballot {
