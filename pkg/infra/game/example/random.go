...
func (r *RandomAgent) LootAllocation(baseAgent agent.BaseAgent, decision message.Proposal[decision.LootAction]) immutable.Map[commons.ID, immutable.SortedMap[commons.ItemID, struct{}]] {
